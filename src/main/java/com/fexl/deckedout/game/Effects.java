...
/**
 * Used to add {@link net.minecraft.world.effect.MobEffect}s to dungeon characters such as Mobs and {@link com.fexl.deckedout.game.User}s.
 */
public class Effects {
	...
	/**
	 * Affects a group of characters specifically, such as a group of Ravagers on {@link com.fexl.deckedout.DOLevel} 1, or some {@link com.fexl.deckedout.game.Lackey}s on {@link com.fexl.deckedout.DOLevel} 2.
	 */
	...
	/**
	 * Targets an individual entity to receive a specific effect. This will most often be used to target the {@link com.fexl.deckedout.game.DOPlayer}
	 */
